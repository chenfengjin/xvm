...
func TestNewContext(t *testing.T) {
	withCode(t, "testdata/add.wat", nil, 0, func(code Code) {
...
func TestResolveFunc(t *testing.T) {
	...
	withCode(t, "testdata/extern_func.wat", r, 0, func(code Code) {
		ctx, err := code.NewContext(DefaultContextConfig())
		if err != nil {
			t.Fatal(err)
		}
...
func TestGasUsed(t *testing.T) {
	...
	withCode(t, "testdata/malloc.wat", r, 0, func(code Code) {
		ctx, err := code.NewContext(DefaultContextConfig())
		if err != nil {
			t.Fatal(err)
		}
...
func BenchmarkExecParallel(b *testing.B) {
	...
	withCode(b, "testdata/extern_func.wat", r, 0, func(code Code) {
